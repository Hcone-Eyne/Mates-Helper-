...
try:
    from . import preferences, db
except ImportError:  # pragma: no cover - allows running this file as a standalone script
    from File_Manager import preferences, db
...
def ensure_vault():
    INBOX.mkdir(parent=True, exist_ok=True)
    for cat in CATEGORIES:
        (VAULT_ROOT / cat).mkdir(parent=True, exist_ok=True)
